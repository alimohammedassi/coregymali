...
class _ProfilePageState extends State<ProfilePage>
  ...
  String _userEmail = '';
  String _avatarUrl =
      'https://images.unsplash.com/photo-1535713875002-d1d0cfd492da?q=80&w=400&auto=format&fit=crop';
  String _age = '--';
  String _weight = '--';
  String _height = '--';
  String _goal = '--';
  ...
  Future<void> _loadExtendedStats() async {
    try {
      ...
      _totalCaloriesThisMonth = (results[1] as List).fold<int>(
        0,
        (s, r) => s + ((r['calories_consumed'] as num?)?.toInt() ?? 0),
      );
  ...
  String _getRawGoal(String formatted) {
    final l10n = AppLocalizations.of(context)!;
    final reverseMap = {
    ...
    return reverseMap[formatted] ?? 'general_fitness';
  }
                    ...
                    delegate: SliverChildListDelegate([
                      ...
                      _a(
                        ...
                        Row(
                          ...
                          children: [
                            _SectionLabel(
                              AppLocalizations.of(context)!.operativeData,
                            ),
                            IconButton(
                              icon: const Icon(
                                Icons.edit_rounded,
                              ...
                              onPressed: () =>
                                  _showEditOperativeDataSheet(context),
                            ),
                          ],
                        ),
                      ),
                      ...
                      _a(
                        4,
                        _SectionLabel(AppLocalizations.of(context)!.thisMonth),
                      ),
                      const SizedBox(height: 10),
                      ...
                      if (_exerciseProgress.isNotEmpty) ...[
                        _a(
                          5,
                          _SectionLabel(
                            AppLocalizations.of(context)!.rmProgress,
                          ),
                        ),
                        const SizedBox(height: 10),
    ...
    return Row(
      children: [
        ...
        _StatChip(
          ...
          label: AppLocalizations.of(context)!.thisMonthWorkouts,
          icon: Icons.calendar_month_rounded,
        ),
        const SizedBox(width: 10),
        _StatChip(
          value: '${(_totalCaloriesThisMonth / 1000).toStringAsFixed(1)}k',
          label: AppLocalizations.of(context)!.kcalLogged,
  ...
  Widget _buildEditGoalsBtn() {
    return _ActionButton(
      label: AppLocalizations.of(context)!.editGoalsTitle,
  ...
  void _showEditOperativeDataSheet(BuildContext context) {
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      items: [
                        DropdownMenuItem(
                          value: 'weight_loss',
                          child: Text(AppLocalizations.of(context)!.weightLoss),
                        ),
                        DropdownMenuItem(
                          value: 'muscle_gain',
                          child: Text(AppLocalizations.of(context)!.muscleGain),
                        ),
                        DropdownMenuItem(
                          value: 'endurance',
                          child: Text(AppLocalizations.of(context)!.endurance),
                        ),
                        DropdownMenuItem(
                          value: 'flexibility',
                          child: Text(
                        ...
                        DropdownMenuItem(
                          ...
                          child: Text(
                            AppLocalizations.of(context)!.generalFitness,
                          ),
                        ),
                      ],
                      onChanged: (val) {
                        if (val != null) {
                          setSheetState(() => selectedGoal = val);
                        }
                      },
                    ),
                  ),
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 10),
                  Text(
                    AppLocalizations.of(context)!.editGoalsTitle,
                    style: AppText.headlineSm.copyWith(
                      fontSize: 18,
                      letterSpacing: 1.5,
                    ),
              ...
              const SizedBox(height: 24),
              _GoalInput(
                label: AppLocalizations.of(context)!.dailyCalories,
                unit: AppLocalizations.of(context)!.kcal,
                controller: calCtrl,
                icon: Icons.local_fire_department_rounded,
                color: AppColors.primaryFixed,
              ...
              const SizedBox(height: 12),
              _GoalInput(
                label: AppLocalizations.of(context)!.dailyProtein,
                unit: 'g',
                controller: protCtrl,
                icon: Icons.egg_alt_outlined,
                color: const Color(0xFFFF6B6B),
              ...
              const SizedBox(height: 12),
              _GoalInput(
                label: AppLocalizations.of(context)!.weeklyWorkoutsLabel,
                unit: '×',
                controller: wkCtrl,
                icon: Icons.fitness_center_rounded,
                color: const Color(0xFF4DC591),
                    ...
                    try {
                      ...
                      if (uid != null) {
                        await db.from('user_goals').upsert({
                          ...
                          'daily_protein_g':
                              int.tryParse(protCtrl.text) ?? _dailyProtein,
                          'weekly_workouts':
