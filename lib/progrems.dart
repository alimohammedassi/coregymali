  ...
  Map<String, dynamic> getMuscleData(String muscle) {
    final data = {
     ...
     'arms': {
      ...
      'back': {
        'title': '🦅 BACK Training',
        'intro': 'A strong back creates the ultimate V-taper aesthetic. Build thickness and width.',
        'gradient': const LinearGradient(colors: [Color(0xFF3A1C71), Color(0xFFD76D77)]),
        'icon': Icons.airline_seat_flat_angled,
        'exercises': [
          {'name': 'Deadlifts', 'description': 'The ultimate compound movement for total back strength.', 'sets': '4 sets × 6-8 reps', 'video': 'https://youtube.com/watch?v=ytGaGIn3SjE', 'image': 'assets/images/deadlifts.jpg'},
          {'name': 'Pull-Ups', 'description': 'Essential for back width and lats development.', 'sets': '4 sets × 8-12 reps', 'video': 'https://youtube.com/watch?v=eGo4IYlbE5g', 'image': 'assets/images/pull_ups.jpg'},
          {'name': 'Barbell Rows', 'description': 'Builds thickness in the mid-back.', 'sets': '3 sets × 8-10 reps', 'video': 'https://youtube.com/watch?v=9efgcAjQe7E', 'image': 'assets/images/barbell_rows.jpg'},
          {'name': 'Lat Pulldowns', 'description': 'Isolates the lats for width.', 'sets': '3 sets × 10-12 reps', 'video': 'https://youtube.com/watch?v=CAwf7n6Luuc', 'image': 'assets/images/lat_pulldowns.jpg'},
          {'name': 'Seated Cable Rows', 'description': 'Great for mid and lower back thickness.', 'sets': '3 sets × 12 reps', 'video': 'https://youtube.com/watch?v=GZbfZ033f74', 'image': 'assets/images/seated_rows.jpg'},
        ],
        'tips': ['Depress your scapula before pulling', 'Lead with your elbows', 'Control the eccentric phase'],
        'quote': '"Blood, sweat and respect. First two you give, last one you earn." - The Rock',
      },
      'shoulders': {
        'title': '🎃 SHOULDERS Training',
        'intro': 'Broad shoulders give the illusion of a smaller waist and dominate any physique.',
        'gradient': const LinearGradient(colors: [Color(0xFFFF9966), Color(0xFFFF5E62)]),
        'icon': Icons.accessibility,
        'exercises': [
          {'name': 'Overhead Press', 'description': 'Core strength builder for the shoulders.', 'sets': '4 sets × 8 reps', 'video': 'https://youtube.com/watch?v=2yjwXTZQDDI', 'image': 'assets/images/ohp.jpg'},
          {'name': 'Lateral Raises', 'description': 'Isolates lateral delts for strict width.', 'sets': '4 sets × 15 reps', 'video': 'https://youtube.com/watch?v=3VcKaXpzqRo', 'image': 'assets/images/lateral_raises.jpg'},
          {'name': 'Front Raises', 'description': 'Develops the anterior deltoid.', 'sets': '3 sets × 12 reps', 'video': 'https://youtube.com/watch?v=-t7fuZ0KhDA', 'image': 'assets/images/front_raises.jpg'},
          {'name': 'Reverse Pec Deck', 'description': 'Isolates the rear delts perfectly.', 'sets': '3 sets × 15 reps', 'video': 'https://youtube.com/watch?v=W-AEE8qfFmQ', 'image': 'assets/images/rear_delts.jpg'},
        ],
        'tips': ['Keep a slight bend in elbows during raises', 'Focus on time under tension'],
        'quote': '"Vision creates faith and faith creates willpower." - Arnold',
      },
      'push': {
        'title': '🔥 PUSH Workout',
        'intro': 'Target your chest, shoulders, and triceps all in one massive workout.',
        'gradient': const LinearGradient(colors: [Color(0xFFff9a44), Color(0xFFfc6076)]),
        'icon': Icons.pan_tool,
        'exercises': [
          {'name': 'Bench Press', 'description': 'Heavy compound pushing movement.', 'sets': '4 sets × 8 reps', 'video': 'https://youtube.com/watch?v=rT7DgCr-3pg', 'image': 'assets/images/bench_press.jpg'},
          {'name': 'Overhead Press', 'description': 'Heavy shoulder press.', 'sets': '3 sets × 8 reps', 'video': 'https://youtube.com/watch?v=2yjwXTZQDDI', 'image': 'assets/images/ohp.jpg'},
          {'name': 'Incline Dumbbell Press', 'description': 'Upper chest focus.', 'sets': '3 sets × 10 reps', 'video': 'https://youtube.com/watch?v=8iPEnn-ltC8', 'image': 'assets/images/incline_dumbbell_press.jpg'},
          {'name': 'Lateral Raises', 'description': 'Side delt isolation.', 'sets': '4 sets × 15 reps', 'video': 'https://youtube.com/watch?v=3VcKaXpzqRo', 'image': 'assets/images/lateral_raises.jpg'},
          {'name': 'Tricep Pushdowns', 'description': 'Isolates the triceps.', 'sets': '3 sets × 12 reps', 'video': 'https://youtube.com/watch?v=2-LAMcpzODU', 'image': 'assets/images/triceps.jpg'},
        ],
        'tips': ['Pace yourself for the multiple compound movements', 'Keep your core braced'],
        'quote': '"No pressure, no diamonds." - Thomas Carlyle',
      },
      'pull': {
        'title': '⚙️ PULL Workout',
        'intro': 'Hit your entire back, rear delts, and biceps for total pulling power.',
        'gradient': const LinearGradient(colors: [Color(0xFF1CB5E0), Color(0xFF000851)]),
        'icon': Icons.fitness_center,
        'exercises': [
          {'name': 'Deadlifts', 'description': 'Full body pulling strength.', 'sets': '3 sets × 5 reps', 'video': 'https://youtube.com/watch?v=ytGaGIn3SjE', 'image': 'assets/images/deadlifts.jpg'},
          {'name': 'Pull-Ups', 'description': 'Vertical pull masterclass.', 'sets': '3 sets × 10 reps', 'video': 'https://youtube.com/watch?v=eGo4IYlbE5g', 'image': 'assets/images/pull_ups.jpg'},
          {'name': 'Barbell Rows', 'description': 'Heavy horizontal pulling.', 'sets': '3 sets × 8 reps', 'video': 'https://youtube.com/watch?v=9efgcAjQe7E', 'image': 'assets/images/barbell_rows.jpg'},
          {'name': 'Face Pulls', 'description': 'Target upper back and rear delts.', 'sets': '3 sets × 15 reps', 'video': 'https://youtube.com/watch?v=rep-qVOkqgk', 'image': 'assets/images/face_pulls.jpg'},
          {'name': 'Bicep Curls', 'description': 'Isolation for the biceps.', 'sets': '3 sets × 12 reps', 'video': 'https://youtube.com/watch?v=ykJmrZ5v0Oo', 'image': 'assets/images/bicep_curls.jpg'},
        ],
        'tips': ['Pull with your elbows, not your hands', 'Squeeze at the top of the movement'],
        'quote': '"What hurts today makes you stronger tomorrow." - Jay Cutler',
      },
      'upper': {
        'title': '⚡ UPPER Body',
        'intro': 'A complete workout targeting all upper body muscle groups.',
        'gradient': const LinearGradient(colors: [Color(0xFFFDC830), Color(0xFFF37335)]),
        'icon': Icons.fitness_center,
        'exercises': [
          {'name': 'Bench Press', 'description': 'Primary pushing movement.', 'sets': '3 sets × 8 reps', 'video': 'https://youtube.com/watch?v=rT7DgCr-3pg', 'image': 'assets/images/bench_press.jpg'},
          {'name': 'Barbell Rows', 'description': 'Primary pulling movement.', 'sets': '3 sets × 8 reps', 'video': 'https://youtube.com/watch?v=9efgcAjQe7E', 'image': 'assets/images/barbell_rows.jpg'},
          {'name': 'Overhead Press', 'description': 'Vertical press for shoulders.', 'sets': '3 sets × 10 reps', 'video': 'https://youtube.com/watch?v=2yjwXTZQDDI', 'image': 'assets/images/ohp.jpg'},
          {'name': 'Lat Pulldowns', 'description': 'Vertical pull for back width.', 'sets': '3 sets × 12 reps', 'video': 'https://youtube.com/watch?v=CAwf7n6Luuc', 'image': 'assets/images/lat_pulldowns.jpg'},
          {'name': 'Arms Superset', 'description': 'Bicep Curls directly into Tricep Ext.', 'sets': '3 sets × 15 reps', 'video': 'https://youtube.com/watch?v=ykJmrZ5v0Oo', 'image': 'assets/images/arms.jpg'},
        ],
        'tips': ['Alternate push and pull exercises to save time', 'Keep intensity high'],
        'quote': '"Discipline is doing what you hate to do, but doing it like you love it." - Mike Tyson',
      },
      'lower': {
        'title': '🧱 LOWER Body',
        'intro': 'Build thick tree-trunk legs and bulletproof your lower body.',
        'gradient': const LinearGradient(colors: [Color(0xFF00c6ff), Color(0xFF0072ff)]),
        'icon': Icons.directions_run,
        'exercises': [
          {'name': 'Squats', 'description': 'The absolute core of leg days.', 'sets': '4 sets × 8 reps', 'video': 'https://youtube.com/watch?v=Dy28eq2PjcM', 'image': 'assets/images/squats.jpg'},
          {'name': 'Romanian Deadlifts', 'description': 'Bulletproof your hamstrings.', 'sets': '3 sets × 10 reps', 'video': 'https://youtube.com/watch?v=JCXUYuzwNrM', 'image': 'assets/images/rdl.jpg'},
          {'name': 'Leg Press', 'description': 'Overload the quads safely.', 'sets': '3 sets × 12 reps', 'video': 'https://youtube.com/watch?v=IZxyjW7MPJQ', 'image': 'assets/images/leg_press.jpg'},
          {'name': 'Leg Extensions', 'description': 'Isolate the quads for maximum pump.', 'sets': '3 sets × 15 reps', 'video': 'https://youtube.com/watch?v=YyvSfVjQeL0', 'image': 'assets/images/leg_extensions.jpg'},
          {'name': 'Calf Raises', 'description': 'Grow those stubborn calves.', 'sets': '4 sets × 15-20 reps', 'video': 'https://youtube.com/watch?v=gwLzBJYoWlI', 'image': 'assets/images/calf_raises.jpg'},
        ],
        'tips': ['Hit proper depth on squats', 'Wear flat shoes for better stability'],
        'quote': '"There is no substitute for hard work." - Thomas Edison',
      },
      'full_body': {
        'title': '🌍 FULL Body',
        'intro': 'Train every muscle in a single high-efficiency intense session.',
        'gradient': const LinearGradient(colors: [Color(0xFF8E2DE2), Color(0xFF4A00E0)]),
        'icon': Icons.accessibility_new,
        'exercises': [
          {'name': 'Squats', 'description': 'Legs foundation.', 'sets': '3 sets × 8 reps', 'video': 'https://youtube.com/watch?v=Dy28eq2PjcM', 'image': 'assets/images/squats.jpg'},
          {'name': 'Bench Press', 'description': 'Chest and pressing foundation.', 'sets': '3 sets × 8 reps', 'video': 'https://youtube.com/watch?v=rT7DgCr-3pg', 'image': 'assets/images/bench_press.jpg'},
          {'name': 'Barbell Rows', 'description': 'Back and pulling foundation.', 'sets': '3 sets × 8 reps', 'video': 'https://youtube.com/watch?v=9efgcAjQe7E', 'image': 'assets/images/barbell_rows.jpg'},
          {'name': 'Shoulder Press', 'description': 'Delt mass builder.', 'sets': '3 sets × 10 reps', 'video': 'https://youtube.com/watch?v=2yjwXTZQDDI', 'image': 'assets/images/ohp.jpg'},
          {'name': 'Plank', 'description': 'Core strength finish.', 'sets': '3 sets × 60s', 'video': 'https://youtube.com/watch?v=ASdvN_XEl_c', 'image': 'assets/images/plank.jpg'},
        ],
        'tips': ['Focus on compound movements', 'Don\'t burn out too early'],
