...
class AppText {
  ...
  static TextStyle styledDisplayMd({bool isArabic = false, Color color = AppColors.textPrimary}) =>
      TextStyle(
  ...
  static TextStyle styledHeadlineMd({bool isArabic = false, Color color = AppColors.textPrimary}) =>
      TextStyle(
        fontFamily: fontFamily(isArabic: isArabic),
        fontSize: 18,
        fontWeight: FontWeight.w700,
  ...
  static TextStyle styledHeadlineSm({bool isArabic = false, Color color = AppColors.textPrimary}) =>
      TextStyle(
        fontFamily: fontFamily(isArabic: isArabic),
        fontSize: 16,
        fontWeight: FontWeight.w700,
  ...
  static TextStyle styledTitleMd({bool isArabic = false, Color color = AppColors.textPrimary}) =>
      TextStyle(
        fontFamily: fontFamily(isArabic: isArabic),
        fontSize: 14,
        fontWeight: FontWeight.w600,
  ...
  static TextStyle styledTitleSm({bool isArabic = false, Color color = AppColors.textPrimary}) =>
      TextStyle(
        fontFamily: fontFamily(isArabic: isArabic),
        fontSize: 13,
        fontWeight: FontWeight.w600,
  ...
  static TextStyle styledBodySm({bool isArabic = false, Color color = AppColors.textMuted}) =>
      TextStyle(
        fontFamily: fontFamily(isArabic: isArabic),
        fontSize: 11.5,
        fontWeight: FontWeight.w400,
  ...
  static TextStyle styledLabelLg({bool isArabic = false, Color color = AppColors.textPrimary}) =>
      TextStyle(
        fontFamily: fontFamily(isArabic: isArabic),
        fontSize: 12,
        fontWeight: FontWeight.w700,
